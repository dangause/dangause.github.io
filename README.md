...
#### 2. Basic backend setup and deployment.
 I deployed the website using Github pages using Google Domains. I learned about server management, security, and the HTTP protocol.
